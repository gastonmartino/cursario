...
![La nube, la detección y extracción de los datos del siervo](/curso01/subcursos/curso001/medios/sos-011.jpg)

## En el inicio...
Muchos autores coinciden en señalar el comienzo de una nueva época, iniciada ya desde hace un par de siglos, en la que el ser humano se convirtió en un agente transformador a escala global: el Antropoceno —o, de acuerdo a la denominación más provocadora de Parikka, el **Antropobsceno**. Una era apalancada por el surgimiento de doctrinas que presentan al planeta como un recurso enteramente disponible para ser explotado de forma sistemática por corporaciones o Estados. Una especie de credo para justificar con prédicas cínicas los “mitos de la inmaterialidad que sustentan el agotamiento técnico de recursos imprescindibles, la crisis de energía y la movilización corporativa de la Tierra” (Parikka, 2021, p.67). Si para Baudrillard la obscenidad supone la abolición de la metáfora y la celebración de la exposición donde “es necesario que todo comunique, que todo sea funcional, que no haya secretos ni misterios” (1969, p.29), la nueva mística del Antropobsceno procura, paradójicamente, encubrir de forma desvergonzada prácticas no sostenibles, políticamente objetables y éticamente oscuras que sustentan la cultura tecnológica y sus redes corporativas. La misión última del culto del Antropobsceno busca la consagración de un dogma opaco que finge socorrer al sujeto contemporáneo en la comprensión de sus relaciones con la tecnología y con el propio planeta.

### *Una historia apócrifa sobre el arrobamiento del Antropobsceno tardío*:
> **LA GÉNESIS DEL CULTO A LA OBNUBILACIÓN**     
> ___ 
> La innovación en transistores y circuitos integrados (en la década de 1950), el desarrollo de la microcomputadora y la industria del software (en las décadas de 1970 y 1980) y la explosión de Internet (hacia fines de la década de 1990) impulsaron el nacimiento de una congregación de tecnoentusiastas que, a raíz de la consolidación de la región de Silicon Valley como centro tecnológico estratégico, fueron bautizados como los “Seguidores de la Orden del Silicio” (S.O.S. por sus siglas en inglés). La prédica optimista de su verdad técnica atrajo casi de inmediato a incontables adeptos que ciegamente abrazaron el poder divino de la tecnología como fuerza positiva propiciadora del progreso humano.   
> +++
> Muy pronto el número de congregantes se multiplicó y pasaron de ser simples seguidores aficionados a convertirse en devotos fieles, al mismo tiempo que su optimismo inicial devino en un ferviente aceleracionismo que hizo resplandecer con mayor fuerza el aura sagrada de su tecnofanía. Las doctrinas tecnológicas se convirtieron en el canon global y la propia Orden fue renombrada como los “Servidores de la Obra Solucionista” (S.O.S), bajo la eufórica creencia de que era posible concebir al mundo en términos puramente computables. El discurso tecnológico optimista de la primera agrupación rápidamente derivó en hechicería retórica con una sacralidad elusiva que proporcionaba explicaciones mitificadas y abstractas a las dinámicas del Antropobsceno. Es justo en este punto cuando la metáfora de “La Nube” deviene en dogma irrefutable, numen etéreo y objeto de fervorosa veneración.
> +++
> **Del Éxtasis Obsceno al “Arrobamiento Obnubilado”**
> +++
...
## La Veneración de la Pantalla
La pantalla es la creencia fundacional de la obra. “La Nube” es una pantalla. Una metáfora infame ingeniada por el **Pensamiento Computacional** para ocultar una maquinaria colosal, pesada y contaminante detrás de una figura retórica celestial. La obra recurre a las **pantallas para encubrir, entretener, obnubilar y distraer**. La pantalla principal de la experiencia acapara la atención con la portentosa proyección de “La Nube” sobre la pared mayor del recinto. Inmediatamente, el visitante es instruido a usar su propia pantalla —la de su dispositivo móvil personal— a través de un código QR que lo invita a integrarse al acto sublime del arrobamiento. El visitante deviene así en fiel seguidor dispuesto a la entrega incondicional y seducido por las recompensas semiobscenas que “La Nube” no deja de desplegar en su teléfono. Mientras tanto, una tercera pantalla más pequeña y con la forma de una caja para ofrendas (“El Alfolí”) se erige en el extremo opuesto del recinto, contabilizando las ofrendas digitales recibidas —o más bien, extraídas— del dispositivo del seguidor convertido, ya a esta altura, en siervo obsequioso y obnubilado por la luz divina de la experiencia.

![Diagrama de la instalación donde se describe la ubicación de las pantallas de la obra](/curso01/subcursos/curso001/medios/sos-002.jpg) *Figura 1: Boceto de la ubicación de las pantallas de la obra en el recinto.*

## La Pantalla Principal (“La Nube”)
La obra escenifica el rito contemporáneo de veneración ciega a “La Nube”. Ésta es proyectada, flotando expectante y con desenfado, sobre una pantalla perpendicular al suelo —una pantalla dentro de otra pantalla— en una habitación amplia y oscura iluminada sólo por el resplandor de los píxeles de la misma proyección. Texturas sonoras graves junto con reverberaciones, ecos y sutiles cantos sagrados buscan recrear una atmósfera de fascinación y recogimiento que propicie la conexión íntima con lo divino y la rendición a los designios de la voluntad omnipotente de “La Nube”. Por momentos, un código QR se asoma en la esquina inferior izquierda de la pantalla: su escaneo instruye al visitante a entablar un vínculo con el objeto de adoración desplegado en la pantalla.
...
Y como “La Nube” es insaciable, el ritual invita a la experiencia colectiva: múltiples seguidores congregados en el mismo recinto oscuro, obnubilados en sus teléfonos, partícipes de un arrobamiento desenfrenado y orgiástico.

![La proyección de la nube "excitada" ante las interacciones de los siervos](/curso01/subcursos/curso001/medios/sos-006.jpg) *Figura 5: “La Nube” en estado de éxtasis a causa de la interacción con sus seguidores obnubilados.*


## El Instrumento de la Tecnoliturgia
El desarrollo de la ceremonia de obnubilación y renuncia del visitante al poder de “La Nube” no tiene una duración fija ni un tiempo de inicio y finalización. No obstante, cada instancia del ritual fue anticipada por escrito con minuciosidad para instruir claramente al visitante durante el oficio y despejar cuestionamientos que puedan empañar el goce y la entrega a la experiencia. La combinación de lenguajes usados en la redacción de las instrucciones de la liturgia manifiesta el carácter sincrético de la fase de preparación de la obra: “Processing” (p5js) oficia de orquestador primordial de la vivencia interactiva de “La Pantalla Principal” y de la proyección de “El Alfolí” en la pared opuesta. Mientras tanto, se delega al OpenGL Shading Language (GLSL), en su carácter de lengua vernácula de la GPU, la proyección animada de la imaginería ceremonial de “La Nube” y la velación de las imágenes obscenas desplegadas en el feed de las pantallas de los dispositivos móviles de “Los Siervos”. 
...
Una pieza audiovisual despliega un resumen de la obra y parte del proceso, visto a través de las pantallas del ***Screening Operating System (SOS)***, un sistema operativo diseñado para la optimización de sus pantallas y para el monitoreo —discreto— de sus usuarios seguidores.

![About Screening Operating System](/curso01/subcursos/curso001/medios/sos-009.png)
+++
[youtube:Wrc3IH3UO-M]
+++
![Loader de carga de SOS](/curso01/subcursos/curso001/medios/sos-010.png)
