...
export const SUBCURSOS: SubcursoDefinition[] = [
 ...
 //
  ...
  },
  {
    ...
    code: 'TFIC:03', title: 'Intereses, objetos, amuletos y miedos',
 ...
 //
  {
    ...
    timeReference: '2025', 
    accentColor: '#16253D', 
    categoryLabel: 'PNG: 4320 x 7680', 
    captionLabel: '1 EDITION',
  ...
  },
  {
    ...
    timeReference: '2024', 
    accentColor: '#16253D', 
    categoryLabel: 'GIF ANIMADO', 
    captionLabel: '15 EDITIONS',
