    ...
    items: [
      {
        id: 'bitacora-01',
        code: 'BIT-01',
        title: 'Estudios de Materia & Papel',
      ...
      },
      {
        id: 'bitacora-02',
        code: 'BIT-02',
        title: 'Sensores, Tensión & Viscosidad',
        subtitle: 'Registro de Taller #02',
        summary: 'Prototipado de circuitos de lectura analógica para captar perturbaciones físicas y transformarlas en trazos vectoriales.',
        x: 0,
        y: 120,
        width: 640,
        height: 660,
        accentColor: '#E03E2D',
        tag: 'CIRCUITOS & SENSÓRICA'
      },
      {
        id: 'bitacora-03',
        code: 'BIT-03',
    ...
    items: [
      {
        ...
        summary: 'Series de imágenes fijas y capturas de movimiento basadas en campos vectoriales de ruido Perlin y resistencia viscosa.',
        x: -720,
        y: -60,
        width: 640,
        height: 660,
